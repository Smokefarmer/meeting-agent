...
- **LLM**: Claude CLI subprocess (`claude --print`) — no API key needed
...
4. **Rate limit API calls** — Respect provider limits (GitHub, Claude CLI). Implement exponential backoff
